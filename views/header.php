        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if($isAuthenticated): ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/index.php?action=see-sent-emails-page"><span style="color:#703900; padding:0 4px 2px 4px; background-color:#D1F5FF; border-radius:5px;">Sent Emails</span></a>
                    </li>
                    <li class="nav-item">
